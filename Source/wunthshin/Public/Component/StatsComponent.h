...
public:
	...
	{
		float requiredExp = CurrentStats.CurrentRequiredExp - CurrentStats.PostRequiredExp;
		float remainedExp = CurrentStats.CurrentRequiredExp - CurrentStats.CurrentExp;
		return (requiredExp - remainedExp) / 100.f;
	}
